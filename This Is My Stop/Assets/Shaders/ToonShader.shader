Shader "Custom/ToonShader" {
	Properties{
		...
		_MainTex("Main Texture", 2D) = "Character Skin" {}
...
#pragma vertex vert
		//Using a vertex-shader called vert
#pragma fragment frag
		//Using a fragment-shader called frag
	...
	return float4(combinedLight, 1.0); // + tex2D(_MainTex, input.uv); // DELETE LINE COMMENTS IF I WANT TO ADD ADDITIONAL TEXUTURE LAYER
